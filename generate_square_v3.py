...
/* 明城墙牌匾 - 挂墙样式 */
.wall-plaque { position:absolute; top:20%; left:45%; transform:translateX(-50%); z-index:10;
...
.wall-plaque::before, .wall-plaque::after { content:''; position:absolute; top:-12px; width:6px; height:12px; background:#8B7355; border-radius:2px; }
.wall-plaque::before { left:20%; }
.wall-plaque::after { right:20%; }
.plaque-text { font-size:16px; font-weight:700; color:#D4A855; letter-spacing:8px;
    text-shadow:0 1px 2px rgba(0,0,0,0.5); font-family:serif; }

/* 古代墙洞 - 低矮拱形 */
.arch-hole { position:absolute; bottom:0; z-index:8; }
.arch-hole-body { width:100px; height:70px; background:linear-gradient(180deg, #1A1510, #0A0805);
    border-radius:50px 50px 0 0; margin:0 auto;
    box-shadow:inset 0 4px 15px rgba(0,0,0,0.6), 0 -2px 8px rgba(0,0,0,0.3);
    border-top:3px solid rgba(90,75,60,0.4); }
.arch-hole-inner { width:70px; height:45px; background:linear-gradient(180deg, #050302, #080604);
    border-radius:35px 35px 0 0; margin:0 auto; margin-top:12px;
...
<div class="scene" id="scene">
    ...
    <div class="wall-wrap" id="wallWrap">
        ...
        <div class="wall-plaque">
            <div class="plaque-text">明城墙</div>
        </div>

        <!-- 古代墙洞 - 稀疏排列 -->
        <div class="arch-hole" style="left:12%;"><div class="arch-hole-body"><div class="arch-hole-inner"></div></div></div>
        <div class="arch-hole" style="left:38%;"><div class="arch-hole-body"><div class="arch-hole-inner"></div></div></div>
        <div class="arch-hole" style="left:65%;"><div class="arch-hole-body"><div class="arch-hole-inner"></div></div></div>
